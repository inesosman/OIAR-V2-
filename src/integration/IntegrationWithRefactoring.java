...
//        alignmentsFiles.add("Input/SNOMED2NCI.rdf");
		...
		//manager.saveOntology(integratedOntology, new OWLXMLOntologyFormat(), IRI.create(new File("Output/IntegratedOntology_WithRefact.owl")));
		//manager.saveOntology(integratedOntology, new OWLFunctionalSyntaxOntologyFormat(), IRI.create(new File("Output/IntegratedOntology_WithRefact.owl")));	
		//manager.addOntologyStorer(new DLSyntaxOntologyStorer());
		//manager.saveOntology(integratedOntology, new DLSyntaxOntologyFormat(), IRI.create(new File("Output/IntegratedOntology_WithRefact.owl")));
		//manager.addOntologyStorer(new OWLTutorialSyntaxOntologyStorer());
		//manager.saveOntology(integratedOntology, new OWLTutorialSyntaxOntologyFormat(), IRI.create(new File("Output/IntegratedOntology_WithRefact.owl")));
		//manager.saveOntology(integratedOntology, new TurtleOntologyFormat(), IRI.create(new File("Output/IntegratedOntology_WithRefact_Turtle.owl")));
